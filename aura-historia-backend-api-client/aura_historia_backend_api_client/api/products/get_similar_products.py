...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/shops/{shop_id}/products/{shops_product_id}/similar".format(
...
) -> Any | ApiError | list[PersonalizedGetProductSummaryData] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = PersonalizedGetProductSummaryData.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ApiError | list[PersonalizedGetProductSummaryData]]:
    return Response(
...
def sync_detailed(
    ...
    **Asynchronous Processing**: If the product's text embedding has not yet been computed (typically
    for
...
def sync(
    ...
    **Asynchronous Processing**: If the product's text embedding has not yet been computed (typically
    ...
    Returns:
        Any | ApiError | list[PersonalizedGetProductSummaryData]
    """
