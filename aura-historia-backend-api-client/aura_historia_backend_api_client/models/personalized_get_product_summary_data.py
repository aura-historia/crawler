...
if TYPE_CHECKING:
    from ..models.get_product_summary_data import GetProductSummaryData
    from ..models.product_user_state_data import ProductUserStateData


T = TypeVar("T", bound="PersonalizedGetProductSummaryData")


@_attrs_define
class PersonalizedGetProductSummaryData:
    ...
    When user is anonymous, only the product summary data is present.
        ...
        Attributes:
            item (GetProductSummaryData): Lightweight product summary information for use in search results and similar
                products listings.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        item = GetProductSummaryData.from_dict(d.pop("item"))
        ...
        personalized_get_product_summary_data = cls(
            item=item,
            user_state=user_state,
        )

        personalized_get_product_summary_data.additional_properties = d
        return personalized_get_product_summary_data
