...
T = TypeVar("T", bound="ProductEventPriceChangedPayloadData")


@_attrs_define
class ProductEventPriceChangedPayloadData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        product_event_price_changed_payload_data = cls(
            old_price=old_price,
            new_price=new_price,
        )

        product_event_price_changed_payload_data.additional_properties = d
        return product_event_price_changed_payload_data
