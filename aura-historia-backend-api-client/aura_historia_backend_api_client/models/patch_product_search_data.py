...
T = TypeVar("T", bound="PatchProductSearchData")


@_attrs_define
class PatchProductSearchData:
    ...
    Follows the same structure as ProductSearchData but with optional fields.
        ...
        Attributes:
            language (LanguageData | None | Unset): Language for search and localized content
            currency (CurrencyData | None | Unset): Currency for price display
            product_query (None | str | Unset): Text query for searching products (minimum 3 characters when provided)
                Example: laptop bag.
            shop_name (list[str] | None | Unset): Optional filter by exact shop names (keyword matching).
            ...
            exclude_shop_name (list[str] | None | Unset): Optional filter to exclude products from specific shop names
                (keyword matching).
            ...
            shop_type (list[ShopTypeData] | None | Unset): Optional filter by shop types Example: ['MARKETPLACE'].
            ...
            provenance (list[ProvenanceData] | None | Unset): Optional filter by provenance documentation levels Example:
                ['PARTIAL', 'COMPLETE'].
            restoration (list[RestorationData] | None | Unset): Optional filter by restoration work levels Example: ['NONE',
                'MINOR'].
    ...
    product_query: None | str | Unset = UNSET
    shop_name: list[str] | None | Unset = UNSET
    exclude_shop_name: list[str] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        product_query: None | str | Unset
        if isinstance(self.product_query, Unset):
            product_query = UNSET
        else:
            product_query = self.product_query

        shop_name: list[str] | None | Unset
        if isinstance(self.shop_name, Unset):
            shop_name = UNSET
        elif isinstance(self.shop_name, list):
            shop_name = self.shop_name

        else:
            shop_name = self.shop_name

        exclude_shop_name: list[str] | None | Unset
        if isinstance(self.exclude_shop_name, Unset):
            exclude_shop_name = UNSET
        elif isinstance(self.exclude_shop_name, list):
        ...
        if product_query is not UNSET:
            field_dict["productQuery"] = product_query
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_product_query(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        product_query = _parse_product_query(d.pop("productQuery", UNSET))

        def _parse_shop_name(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, list):
                    raise TypeError()
                shop_name_type_0 = cast(list[str], data)

                return shop_name_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(list[str] | None | Unset, data)

        shop_name = _parse_shop_name(d.pop("shopName", UNSET))

        def _parse_exclude_shop_name(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, list):
                    raise TypeError()
                exclude_shop_name_type_0 = cast(list[str], data)

                return exclude_shop_name_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(list[str] | None | Unset, data)

        exclude_shop_name = _parse_exclude_shop_name(d.pop("excludeShopName", UNSET))
        ...
        patch_product_search_data.additional_properties = d
        return patch_product_search_data
