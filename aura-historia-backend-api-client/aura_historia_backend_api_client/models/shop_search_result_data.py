...
T = TypeVar("T", bound="ShopSearchResultData")


@_attrs_define
class ShopSearchResultData:
    """Cursor-paginated collection of shops using keyset pagination

    Attributes:
        items (list[GetShopData]): Array of shops in the current page
        size (int): Number of products in the current page Example: 21.
        search_after (list[Any] | None | Unset): Cursor for the next page (keyset pagination).
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = GetShopData.from_dict(items_item_data)
        ...
        shop_search_result_data.additional_properties = d
        return shop_search_result_data
